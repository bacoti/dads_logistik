...
return new class extends Migration
{
    ...
    {
        // Add sub_project_id to categories table
        ...
        // Add sub_project_id to materials table
    ...
    {
        // Drop foreign keys and columns from materials table
        Schema::table('materials', function (Blueprint $table) {
        ...
        // Drop foreign keys and columns from categories table
        Schema::table('categories', function (Blueprint $table) {
            $table->dropForeign(['sub_project_id']);
