            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="flex justify-between items-center mb-6">
                        <div>
                            <h2 class="text-2xl font-bold">Buat Pengajuan MFO</h2>
                            <p class="text-gray-600 mt-1">Buat pengajuan Material Field Operation baru</p>
                        </div>
                                ...
                                <div class="upload-area border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-gray-400 transition-colors cursor-pointer" id="uploadArea">
                                    ...
                                    <div class="mt-4">
                                        <p class="text-sm text-gray-600">
                                            <button type="button" class="font-medium text-indigo-600 hover:text-indigo-500">Upload file</button>
                                            atau drag and drop
                                        </p>
