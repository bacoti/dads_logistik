<x-app-layout>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="flex justify-between items-center mb-6">
                        <div>
                            <h2 class="text-2xl font-bold text-gray-900">Buat PO Transport Baru</h2>
                            <p class="text-gray-600 mt-1">Upload dokumen Excel untuk pengajuan PO Transport</p>
                        </div>
                        <a href="{{ route('user.po-transports.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition ease-in-out duration-150">
                    ...
                    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-6 mb-8">
                        <div class="flex items-start">
                            ...
                            <div class="ml-3">
                                <h3 class="text-lg font-semibold text-blue-900 mb-2">Petunjuk Penggunaan</h3>
                                <ul class="text-blue-800 space-y-1">
                                    <li class="flex items-start">
                                        <span class="w-1.5 h-1.5 bg-blue-600 rounded-full mt-2 mr-2 flex-shrink-0"></span>
                                        <span>Upload hanya file Excel (.xlsx atau .xls)</span>
                                    </li>
                                    <li class="flex items-start">
                                        <span class="w-1.5 h-1.5 bg-blue-600 rounded-full mt-2 mr-2 flex-shrink-0"></span>
                                    ...
                                    <li class="flex items-start">
                                        <span class="w-1.5 h-1.5 bg-blue-600 rounded-full mt-2 mr-2 flex-shrink-0"></span>
                                        <span>Nomor PO harus unik dan belum pernah digunakan</span>
                                    </li>
                                    <li class="flex items-start">
                                        <span class="w-1.5 h-1.5 bg-blue-600 rounded-full mt-2 mr-2 flex-shrink-0"></span>
                                        <span>Dokumen akan direview oleh admin sebelum disetujui</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <!-- Form -->
                    <form method="POST" action="{{ route('user.po-transports.store') }}" enctype="multipart/form-data" class="space-y-8">
                        @csrf
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <textarea name="description" id="description" rows="4"
                                          ...
                                          placeholder="Tambahkan keterangan atau catatan khusus untuk PO Transport ini...">{{ old('description') }}</textarea>
    ...
    <script>
        ...
        document.querySelector('form').addEventListener('submit', function(e) {
            ...
            if (!document) {
                e.preventDefault();
                alert('Dokumen Excel wajib diupload!');
                return;
            }
