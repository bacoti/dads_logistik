        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            ...
            <div class="p-6 text-gray-900">
                <div class="flex justify-between items-center mb-6">
                    <div>
                        <h2 class="text-2xl font-bold">Laporan Kehilangan</h2>
                        <p class="text-gray-600 mt-1">Kelola semua laporan kehilangan dari pengguna</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                    <div class="bg-blue-50 rounded-lg p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-blue-600 font-medium">Total Laporan</p>
                    ...
                    <div class="bg-blue-50 rounded-lg p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-blue-600 font-medium">Sedang Ditinjau</p>
                                <p class="text-3xl font-bold text-blue-900">{{ $stats['reviewed'] ?? 0 }}</p>
                            </div>
                            <div class="bg-blue-100 p-3 rounded-full">
                                <svg class="w-8 h-8 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="bg-green-50 rounded-lg p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-green-600 font-medium">Selesai</p>
                                <p class="text-3xl font-bold text-green-900">{{ $stats['completed'] ?? 0 }}</p>
                            </div>
                ...
                <div class="bg-gray-50 rounded-lg p-6 mb-6">
                    <form method="GET" action="{{ route('admin.loss-reports.index') }}" class="space-y-4 md:space-y-0 md:flex md:items-end md:space-x-4">
                        <div class="flex-1">
                        ...
                        <div class="flex space-x-2">
                            ...
                            <a href="{{ route('admin.loss-reports.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-300 border border-transparent rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest hover:bg-gray-400 focus:bg-gray-400 active:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition ease-in-out duration-150">
                                Reset
                            </a>
                        </div>
                    </form>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($reports as $report)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">{{ $report->project->name ?? 'N/A' }}</div>
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="text-sm text-gray-900">{{ $report->material_type }}</div>
                                    </td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="7" class="px-6 py-4 whitespace-nowrap text-center text-gray-500">
                                        Tidak ada laporan kehilangan ditemukan
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
