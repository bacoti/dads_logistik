<x-app-layout>
    <x-page-header 
        ...
        subtitle="Kelola penggunaan material untuk proyek"
        :breadcrumbs="[
        ...
        :icon="'<svg class=\'w-8 h-8 mr-3\' fill=\'none\' stroke=\'currentColor\' viewBox=\'0 0 24 24\'><path stroke-linecap=\'round\' stroke-linejoin=\'round\' stroke-width=\'2\' d=\'M13 10V3L4 14h7v7l9-11h-7z\'></path></svg>'"
        >
        <x-slot name="action">
            <div class="flex space-x-3">
                ...
                <x-button 
                    variant="primary"
                    href="{{ route('po.material-usage.create') }}"
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    <dt class="text-sm font-medium text-gray-500 truncate">Total Usage Hari Ini</dt>
                                    <dd class="text-lg font-medium text-gray-900">{{ $stats['today_usage_transactions'] }} transaksi</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-lg font-medium text-gray-900">{{ $stats['total_usage_transactions'] }} transaksi</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    <dt class="text-sm font-medium text-gray-500 truncate">Usage Bulan Ini</dt>
                                    <dd class="text-lg font-medium text-gray-900">{{ number_format($stats['this_month_usage'], 0) }} unit</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-lg font-medium text-gray-900">{{ $stats['active_projects_with_usage'] }} project</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-white shadow-sm rounded-lg">
                <div class="p-6 border-b border-gray-200">
                    <div class="flex items-center justify-between">
                        <h3 class="text-lg font-medium text-gray-900">Riwayat Penggunaan Material</h3>
                        <div class="text-sm text-gray-500">
                            {{ $usageTransactions->total() }} total transaksi
                        </div>
                    </div>
                </div>

                @if($usageTransactions->count() > 0)
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach($usageTransactions as $usage)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-4">
                                                <div class="text-sm font-medium text-gray-900">{{ $usage->poMaterialItem->nama_material }}</div>
                                                <div class="text-sm text-gray-500">{{ $usage->poMaterialItem->satuan }}</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-800">
                                            -{{ number_format($usage->quantity, 0) }}
                                        </span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        {{ $usage->notes ?: 'Penggunaan umum' }}
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        {{ $usage->user->name }}
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <a href="{{ route('po.material-usage.show', $usage) }}" 
                ...
                <div class="text-center py-12">
                    ...
                    <h3 class="mt-2 text-sm font-medium text-gray-900">Belum Ada Penggunaan Material</h3>
                    <p class="mt-1 text-sm text-gray-500">Mulai catat penggunaan material untuk melacak stock.</p>
                    <div class="mt-6">
                        <x-button 
                            variant="primary"
                            href="{{ route('po.material-usage.create') }}"
